...
import { DroppableAreas, resetIsOver, selectIsDragging, setIsOver } from '~/src/store/slices/ui';
  ...
  return (
    <div
      ...
      className={classNames({
        ...
        'bg-light-blue-50':
          isDragging.droppableAreasIds.includes(id) && React.Children.count(children) === 0
      })}
    >
